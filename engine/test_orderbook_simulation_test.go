...
func TestNormalMatch(t *testing.T) {
	...
	ob.InsertOrder(models.Metadata{Order: models.Order{Id: 1, Order_Type: "limit", Side: "sell", Price: 100, Quantity: 10, Status: "pending"}, Remq: 10})
	fmt.Println("Inserted 1")
	// Insert a buy order at price 110, quantity 10
	ob.Matcher(models.Metadata{Order: models.Order{Id: 2, Side: "buy", Order_Type: "limit", Price: 110, Quantity: 10, Status: "pending"}, Remq: 10})
...
func TestPartialFill(t *testing.T) {
	...
	ob.InsertOrder(models.Metadata{Order: models.Order{Id: 3, Order_Type: "limit", Side: "sell", Price: 200, Quantity: 5, Status: "pending"}, Remq: 5})
	ob.sellCount++
	// Insert a buy order with quantity 10
	ob.InsertOrder(models.Metadata{Order: models.Order{Id: 4, Order_Type: "limit", Side: "buy", Price: 200, Quantity: 10, Status: "pending"}, Remq: 10})
	ob.buyCount++
	// Matcher should partially fill the buy order
	ob.Matcher(models.Metadata{Order: models.Order{Id: 4, Order_Type: "limit", Side: "buy", Price: 200, Quantity: 10, Status: "pending"}, Remq: 10})
...
func TestCancelBeforeMatch(t *testing.T) {
	ob := setupOrderbook()
	err := ob.InsertOrder(models.Metadata{Order: models.Order{Id: 5, Order_Type: "limit", Side: "buy", Price: 150, Quantity: 5, Status: "pending"}, Remq: 5})
...
func TestCancelAfterPartial(t *testing.T) {
	...
	ob.InsertOrder(models.Metadata{Order: models.Order{Id: 6, Order_Type: "limit", Side: "sell", Price: 250, Quantity: 20, Status: "pending"}, Remq: 20})
	ob.sellCount++
	// Trigger partial match of 10 units
	ob.Matcher(models.Metadata{Order: models.Order{Id: 7, Order_Type: "limit", Side: "buy", Price: 250, Quantity: 10, Status: "pending"}, Remq: 10})
...
func TestConcurrentCancellations(t *testing.T) {
	...
	for i := uint64(100); i < 110; i++ {
		ob.InsertOrder(models.Metadata{Order: models.Order{Id: i, Order_Type: "limit", Side: "buy", Price: 300, Quantity: 1, Status: "pending"}, Remq: 1})
		ob.buyCount++
	}
...
func TestInvalidOrderType(t *testing.T) {
	...
	node := &Node{Metadata: models.Metadata{Order: models.Order{Id: 10, Order_Type: "limit", Side: "hold", Price: 100, Quantity: 1, Status: "pending"}, Remq: 1}}
...
func TestStressScenario(t *testing.T) {
	...
	for i := 1; i <= 100; i++ {
		...
		ob.InsertOrder(models.Metadata{Order: models.Order{Id: uint64(1000 + i), Order_Type: "limit", Side: side, Price: float64(100 + i%5), Quantity: 1, Status: "pending"}, Remq: 1})
		if i%10 == 0 {
			ob.Matcher(models.Metadata{Order: models.Order{Id: uint64(2000 + i), Order_Type: "limit", Side: side, Price: float64(100 + i%5), Quantity: 1, Status: "pending"}, Remq: 1})
		}
		if i%15 == 0 {
